      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=4">Add PROFESSOR</a></li>
            <li><a href="headdash.php?q=5">Remove PROFESSOR</a></li>
          </ul>
        </li>
      </ul> 
          </div>
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Professor Details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="email" placeholder="Enter Professor Email" class="form-control input-md" type="email">
